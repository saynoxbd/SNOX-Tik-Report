...
print('\033[1;31m[💐] 2-𝐂𝐡𝐨𝐬𝐬𝐞 𝐑𝐞𝐩𝐨𝐫𝐭 \n')
kurd = input('\033[1;36m[+] 𝐂𝐡𝐨𝐬𝐬𝐞 ==> : \x1b[0m')
if kurd == '1':
    time.sleep(1)
    print('''
[💛] 𝐎𝐫𝐠𝐢𝐧𝐚𝐥 𝐑𝐞𝐩𝐨𝐫𝐭
[💚] 𝐑𝐞𝐩𝐨𝐫𝐭 𝐇𝐚𝐭𝐞 𝐒𝐩𝐞𝐞𝐜𝐡
[❤️] 𝐒𝐮𝐢𝐜𝐢𝐝𝐞, 𝐒𝐞𝐥𝐟 𝐑𝐞𝐩𝐨𝐫𝐭
''')
    time.sleep(1)
    print('[🔥] 𝐑𝐄𝐏𝐎𝐑𝐓 𝐀𝐋𝐋 ....')
    time.sleep(1)
    print("")
    id1 = input('\033[1;36m[⚠️] 𝐄𝐧𝐭𝐞𝐫 𝐕𝐢𝐜𝐭𝐢𝐦 𝐓𝐚𝐫𝐠𝐞𝐭 𝐈𝐃 ==> : \x1b[0m')
    print('[☢️] 𝐑𝐄𝐏𝐎𝐑𝐓 𝐒𝐓𝐀𝐑𝐓𝐈𝐍𝐆••••••••••••')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req1:
            print('\033[1;92m[😭] 🔺𝐑𝐄𝐏𝐎𝐑𝐓 𝐔𝐍𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋🎭')
        else:
            print('\033[0;92m[🤩] 🔥𝐑𝐄𝐏𝐎𝐑𝐓 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋☢️')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req2:
            ...
            print('\033[0;31m[😭] 🔺𝐑𝐄𝐏𝐎𝐑𝐓 𝐔𝐍𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋🎭')
        time.sleep(3)
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req3:
            print('\033[0;92m[😭] 🔺𝐑𝐄𝐏𝐎𝐑𝐓 𝐔𝐍𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋🎭')
        else:
            print('\033[0;92m[🤩] 🔥𝐑𝐄𝐏𝐎𝐑𝐓 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋☢️')
if kurd == '2':
    print('''
[💛] 1- 𝐎𝐫𝐠𝐢𝐧𝐚𝐥 𝐑𝐞𝐩𝐨𝐫𝐭
[💚] 2- 𝐑𝐞𝐩𝐨𝐫𝐭 𝐇𝐚𝐭𝐞 𝐒𝐩𝐞𝐞𝐜𝐡
[🥰] 3- 𝐒𝐮𝐢𝐜𝐢𝐝𝐞, 𝐒𝐞𝐥𝐟 𝐑𝐞𝐩𝐨𝐫𝐭
''')
kurd2 = input('\033[1;36m[🔥] 𝐂𝐡𝐨𝐬𝐬𝐞 ==> : \x1b[0m')
if kurd2 == '1':
    username = input('\033[1;36m[⚠️] 𝐄𝐧𝐭𝐞𝐫 𝐕𝐢𝐜𝐭𝐢𝐦 𝐓𝐚𝐫𝐠𝐞𝐭 𝐈𝐃 ==> : \x1b[0m')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req5:
            ...
            print('\033[0;92m[🤩] 🔥𝐑𝐄𝐏𝐎𝐑𝐓 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋☢️')
if kurd2 == '2':
    username2 = input('\033[1;36m[+] 𝐄𝐧𝐭𝐞𝐫 𝐕𝐢𝐜𝐭𝐢𝐦 𝐓𝐚𝐫𝐠𝐞𝐭 𝐈𝐃 ==> : \x1b[0m')
    ...
    while True:
        ...
        if '{"statusCode":0,"body":{"statusCode":0,"errMsg":"نشكرك على ملاحظاتك"},"errMsg":"نشكرك على ملاحظاتك"}' in req6:
            ...
            print('\033[0;92m[🤩] 🔥𝐑𝐄𝐏𝐎𝐑𝐓 𝐒𝐔𝐂𝐂𝐄𝐒𝐒𝐅𝐔𝐋☢️')
if kurd2 == '3':
    username3 = input('\033[1;36m[+] 𝐄𝐧𝐭𝐞𝐫 𝐕𝐢𝐜𝐭𝐢𝐦 𝐓𝐚𝐫𝐠𝐞𝐭 𝐈𝐃 ==> : \x1b[0m')
